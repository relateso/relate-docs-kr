...
고객 유형, 세일즈 프로세스, 그리고 제품 유형에 따라 달라질 수 있지만 모든 팀이 공통적으로 관리해야 하는 고객 정보 중 하나가 바로 Prospect status입니다. Prospect status를 활용해 체계적으로 잠재 고객 관리를 하고 싶은 경우 먼저 Prospect 기능을 [Admin Page](https://app.relate.so/)에서 활성화해야 사용할 수 있습니다.
