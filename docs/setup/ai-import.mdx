...
## AI 임포트 실행 가이드 (Step-by-Step)
  ...
  <Tip>
    <div style={{ margin: "0", display: "grid", rowGap: "4px", lineHeight: "1.4" }}>
      <div style={{ margin: "0" }}>
        Field type은 Contact Field와 Organization Field 두 가지로 구분됩니다.
      </div>
      <div style={{ display: "grid", rowGap: "0", margin: "0" }}>
...
<br />
## 임포트 결과를 보고 꼭 확인하세요
임포트가 정상적으로 완료되었더라도, 아래 사항은 반드시 한 번 더 확인하는 것을 권장합니다.
